...
import me.devziyad.springbootbackend.notification.NotificationService;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentResponse initiatePayment(InitiatePaymentRequest request, Long payerId) {
        ...
        if (booking.getStatus() == me.devziyad.springbootbackend.common.BookingStatus.CANCELLED) {
        ...
        if (request.getMethod() != PaymentMethod.CASH) {
            ...
            notificationService.createNotification(
                    ...
                    me.devziyad.springbootbackend.common.NotificationType.PAYMENT_RECEIVED
            );
        }
