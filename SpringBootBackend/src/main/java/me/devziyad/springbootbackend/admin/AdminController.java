package me.devziyad.springbootbackend.admin;
...
import me.devziyad.springbootbackend.payment.PaymentRepository;
...
import me.devziyad.springbootbackend.user.UserService;
...
public class AdminController {
    ...
    public ResponseEntity<Ride> getRide(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(rideRepository.findById(id)
                .orElseThrow(() -> new me.devziyad.springbootbackend.exception.ResourceNotFoundException("Ride not found")));
    }
    ...
    public ResponseEntity<Booking> getBooking(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(bookingRepository.findById(id)
                .orElseThrow(() -> new me.devziyad.springbootbackend.exception.ResourceNotFoundException("Booking not found")));
    }
    ...
    public ResponseEntity<Payment> getPayment(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(paymentRepository.findById(id)
                .orElseThrow(() -> new me.devziyad.springbootbackend.exception.ResourceNotFoundException("Payment not found")));
    }
